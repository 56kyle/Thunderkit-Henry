...
{
    internal class ModdedSurvivorCamelUzi : UnlockableCreator.ModdedSurvivorCamelAchievement
    {
        ...
        public override UnlockableDef UnlockableDef => Modules.Assets.mainAssetBundle.LoadAsset<UnlockableDef>("Skills.ModdedSurvivorCamel.SecondaryAlt1");
        ...
        {
            UnlockableCreator.AddUnlockable<ModdedSurvivorCamelUzi>(true);
        }
