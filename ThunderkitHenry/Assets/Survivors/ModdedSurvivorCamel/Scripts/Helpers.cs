...
namespace ModdedSurvivorCamel.Modules
{
    internal static class Helpers
    {
        ...
        // This code wont be run if 'Debug' is off within ModdedSurvivorCamelPlugin.
        ...
        // replace `ModdedSurvivorCamel.SkillStates.SlashCombo` with a skillstate in your mod. 
        private static void PrintEntityStatesForConfigNames()
        {
            var state = new SerializableEntityStateType(typeof(ModdedSurvivorCamel.SkillStates.Shoot));
            Debug.LogWarning(ModdedSurvivorCamelPlugin.MODNAME + ": DEBUG: TypeName print: " + state.typeName);
        }
    }
