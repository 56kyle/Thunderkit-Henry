...
namespace ModdedSurvivorCamel.Modules.Components
{
    // just a class to run some custom code for things like weapon models
    // Attached as a component onto ModdedSurvivorCamelBody.
    public class ModdedSurvivorCamelController : MonoBehaviour
    {
        ...
        {
            if (this.characterBody.skillLocator.secondary.skillDef.skillNameToken == ModdedSurvivorCamelPlugin.developerPrefix + "_ModdedSurvivorCaps_BODY_SECONDARY_UZI_NAME")
            {
