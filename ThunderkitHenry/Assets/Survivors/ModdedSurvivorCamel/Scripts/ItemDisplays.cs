...
namespace ModdedSurvivorCamel.Modules
{
    internal static class ItemDisplays
    {
        ...
        {
            var ModdedSurvivorLowerRules = Prefabs.bodyPrefabs[0].GetComponentInChildren<CharacterModel>().itemDisplayRuleSet;
            ModdedSurvivorLowerRules.keyAssetRuleGroups = CreateItemDisplaysModdedSurvivorCamel();
            ModdedSurvivorLowerRules.GenerateRuntimeValues();
        ...
        private static ItemDisplayRuleSet.KeyAssetRuleGroup[] CreateItemDisplaysModdedSurvivorCamel()
        {
            var itemDisplayRules = new List<ItemDisplayRuleSet.KeyAssetRuleGroup>();

            #region ModdedSurvivorCamel Item Displays
