...
//Do a 'Find and Replace' on the ModdedSurvivorCamel namespace. Make your own namespace, please.
namespace ModdedSurvivorCamel
{
    ...
    public class ModdedSurvivorCamelPlugin : BaseUnityPlugin
    {
        // if you don't change these you're giving permission to deprecate the mod-
        //  please change the names to your own stuff, thanks
        //   this shouldn't even have to be said
        public const string MODUID = "com.valex.ModdedSurvivorCamel";
        public const string MODNAME = "ModdedSurvivorCamel";
        ...
        public static ModdedSurvivorCamelPlugin instance;
